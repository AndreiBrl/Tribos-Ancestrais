...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Yacamim sentiu o calor tocar sua pele. Percebeu que conseguia se mexer e tentou abrir os olhos. Estava entardecendo e uma fogueira crepitava ao seu lado, ele virou o rosto e viu Iyamora sentada de costas. Aos poucos levantou-se e sentiu como se tivesse dormido por dias, não tinha ideia do que realmente tinha acontecido. Lembrou-se de estar dentro do riacho ao pé da grande árvore, rodeado de criaturas sedentas por sangue. </p>
        ...
        <p>Yacamim se levantou e saiu caminhando, uma brisa leve acariciou seu rosto, sentiu o cheiro da floresta e a paz do local, estava no topo da montanha onde Iyamora vivia. </p>
