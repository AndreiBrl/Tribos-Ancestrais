...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Momentos depois, Fakuri e Kizuno cavalgavam por entre os alojamentos e cumprimentavam os conhecidos com sorrisos e acenos, seguidos por Akin, que recebia olhares estranhos por parte de membros de outras aldeias. </p>
        <p>Logo chegaram em uma cabana que tinha um círculo com as bordas cortadas por linhas, pintado em tinta vermelha escura, era o símbolo da tribo Or’ri. </p>
        <br></br>
        <br></br>
        <img src="/img/cap3/cabana.png"></img>
        <br></br>
        <br></br>
        {/* <br></br>
        <br></br> */}
