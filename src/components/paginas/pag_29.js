...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <br></br>
        <br></br>
        <img style={{ height: '70vw' }} src="/img/cap4/Muktos.png"></img>
        <br></br>
        <br></br>

        <p>— Xa’ru Muk’tos Oc’to!! — Vociferou Yacamim. Seu braço se contorceu e ele sentiu a Xaruna percorrendo seu corpo.</p>
        <br></br>
        <br></br>
        <img style={{ height: '90vw' }} src="/img/cap4/Muktos2.png"></img>
        <br></br>
        <br></br>
