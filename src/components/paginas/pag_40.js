...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>— O que!? — Perguntou Uthane desesperada.</p>
        <p>— Eu não sei, mas as palavras que ele dizia pareciam ser de um dialeto antigo.  — Disse Chinu levantando-se — Seja o que for, nós vamos extrair de dentro dele. </p>
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <img style={{ height: '90vw' }} src="/img/cap5/ritual_na_cabana.png"></img>
        <br></br>
        <br></br>
        <p>Lá dentro, tochas e velas estavam acesas em todos os cantos, Chinu se aproximou e tomou o gengibre da mão de Uthane, então o jogou em uma bancada.</p>
        <p>Akin estava deitado nu no chão ao lado da fogueira, o corpo com inscrições antigas de cura do povo Or&apos;ri, pintadas em cor verde musgo. A velha curandeira agora tinha nas mãos uma cuia e amassava o gengibre junto de um líquido escuro.</p>
        <p>— Prepare-se. — Disse Chinu. — Quando ele beber este líquido espere meu sinal e jogue isto no fogo. — Uthane estendeu a mão para pegar um pequeno saco de couro e viu dentro um pó branco, que parecia ser sal misturado com algumas raízes.</p>
        ...
        <p>— Por ora, vamos deixá-lo descansar. — disse Chinu, virando-se com serenidade e estendendo a mão para Uthane, que permanecia sentada no chão perplexa.</p>
