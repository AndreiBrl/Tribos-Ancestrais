...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Ele se virou. Chegavam correndo até ele Aina e Onay, seus amigos e filhos de Fakuri. Pararam na frente dele ofegantes.</p>
        <p>— O que está acontecendo Akin? — Perguntou a garota, atropelando a própria respiração.</p>
        <p>Os berros da multidão ao longe cortaram a voz de Akin, que desistiu de falar e fez sinal para que os dois irmãos o seguissem. Saíram os três pela parte de trás da aldeia em direção a casa da mãe de Akin. </p>
        {/* <br></br>
        <br></br>
