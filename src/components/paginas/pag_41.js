...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Amanhecia quente naquele dia no assentamento dos I’akas e a brisa do mar serenava por entre os tecidos das tendas. Os aldeões já se levantavam para iniciar o comércio das especiarias. </p>
        <br></br>
        <br></br>
        <img style={{ height: '80vw' }} src="/img/cap6/chegada.png"></img>
        <br></br>
        <br></br>
