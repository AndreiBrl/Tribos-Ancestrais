...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Na frente da cabana, um estandarte de madeira vazio estava fincado no chão, nesse momento, Fakuri pulou do cavalo, abriu uma bolsa de couro que estava na lateral e dali retirou um tecido amarrado com tiras de cipó, desamarrou e com as duas mãos estendeu ao vento firmemente. Era a bandeira da tribo. Akin observava enquanto ele encaixava a bandeira no estandarte e o símbolo igual ao da cabana se impunha.</p>
