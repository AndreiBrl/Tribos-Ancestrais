...
const Page = () => (
    ...
    <div className={styles.sub_container_1} >
        ...
        <p>Iyamora vivia acima das águas da cachoeira em meio as árvores altas da montanha. Era uma garota xamã que, embora não fosse o costume dessas criaturas, começou a conviver com Yacamin após o incidente que aconteceu no assentamento há muitos anos. Yacamim escalou o restante da montanha, e no topo já bem acima da nascente da cachoeira, uma vegetação densa com árvores prevalecia. O homem adentrou mais a fundo, caminhando até onde seus sentidos o levavam. </p>
        <br></br>
        <br></br>
        <img style={{ height: '80vw' }} src="/img/cap2/YacamimIyamora.png"></img>
        <br></br>
        <br></br>
        ...
        <p>— Eu finalmente senti o fluxo de energia e as vibrações dele — Disse ele, olhando para a pequena.</p>
